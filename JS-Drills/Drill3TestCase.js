import { problem1,problem2, problem3, problem4, problem5, problem6 } from "./Drill3.js";
...
let carId = 33;
const result1 = problem1(inventory,carId);
console.log("Car " + result1.id + " is a " + result1.car_year + " " + result1.car_make + " " + result1.car_model);
  ...
  for(let x in result6){
    console.log(JSON.stringify(result6[x]));
 }
